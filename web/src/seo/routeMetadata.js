...
export const ROUTE_METADATA = {
    ...
    '/support': {
        ...
        description: 'Contact support for The Commissure, an educational 3D atlas of cervical spine procedures.',
        canonical: absoluteUrl('/support'),
        image: absoluteUrl('/about.webp'),
        imageAlt: 'The Commissure support',
        imageWidth: 2249,
        imageHeight: 1616,
        type: 'website',
    },
    '/privacy': {
        ...
        description: 'Read how The Commissure handles information in its current iOS educational app.',
        canonical: absoluteUrl('/privacy'),
        image: absoluteUrl('/about.webp'),
        imageAlt: 'The Commissure privacy policy',
        imageWidth: 2249,
        imageHeight: 1616,
        type: 'website',
    },
